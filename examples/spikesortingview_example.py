...
def main():
    ...
    # You can get a sorting curation uri from a workspace via:
    #     sorting_curation_uri = workspace.get_sorting_curation_uri(sorting_id)
    # You can set the permissions for a sorting curation via:
    #     SpikeSortingView.set_sorting_curation_authorized_users(sorting_curation_uri, user_ids)
    sorting_curation_uri = None # No sorting curation
