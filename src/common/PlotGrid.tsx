...
import { Sorting, SortingInfo } from "../python/sortingview/extensions/pluginInterface";
...
const PlotGrid: FunctionComponent<Props> = ({ sorting, sortingInfo, onUnitClicked, selections,
