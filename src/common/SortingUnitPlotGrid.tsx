...
import { isMergeGroupRepresentative, Sorting, SortingCuration, SortingInfo, SortingSelection, SortingSelectionDispatch } from '../python/sortingview/extensions/pluginInterface';
...
const SortingUnitPlotGrid: FunctionComponent<Props> = ({ sorting, sortingInfo, selection, curation, selectionDispatch, unitComponent }) => {
