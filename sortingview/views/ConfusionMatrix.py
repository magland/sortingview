...
class UnitEventCount:
    def __init__(self, unit_id: Union[int, str], count: int) -> None:
        self.unit_id = unit_id
        self.count = count

    def to_dict(self):
        return {"unitId": self.unit_id, "count": self.count}


class MatchingUnitEventCount:
    def __init__(self, unit_id1: Union[int, str], unit_id2: Union[int, str], count: int) -> None:
        self.unit_id1 = unit_id1
        self.unit_id2 = unit_id2
        self.count = count

    def to_dict(self):
        return {"unitId1": self.unit_id1, "unitId2": self.unit_id2, "count": self.count}
