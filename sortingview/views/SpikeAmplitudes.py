...
class SpikeAmplitudesItem:
    ...
    def to_dict(self):
        ret = {"unitId": self.unit_id, "spikeTimesSec": self.spike_times_sec, "spikeAmplitudes": self.spike_amplitudes}
        return ret
...
class SpikeAmplitudes(View):
    ...
    def __init__(self, *, start_time_sec: float, end_time_sec: float, plots: List[SpikeAmplitudesItem], hide_unit_selector: bool = False, **kwargs) -> None:
