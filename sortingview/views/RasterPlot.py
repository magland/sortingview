...
class RasterPlotItem:
    ...
    def to_dict(self):
        ret = {"unitId": self.unit_id, "spikeTimesSec": self.spike_times_sec}
        return ret
...
class RasterPlot(View):
    ...
    def __init__(self, *, start_time_sec: float, end_time_sec: float, plots: List[RasterPlotItem], **kwargs) -> None:
    ...
    def to_dict(self) -> dict:
        ret = {"type": self.type, "startTimeSec": self._start_time_sec, "endTimeSec": self._end_time_sec, "plots": [a.to_dict() for a in self._plots]}
        return ret
