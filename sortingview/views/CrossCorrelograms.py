...
class CrossCorrelogramItem:
    ...
    def to_dict(self):
        return {"unitId1": self.unit_id1, "unitId2": self.unit_id2, "binEdgesSec": self.bin_edges_sec, "binCounts": self.bin_counts}
...
class CrossCorrelograms(View):
    ...
    def __init__(self, cross_correlograms: List[CrossCorrelogramItem], *, hide_unit_selector: bool = False, **kwargs) -> None:
    ...
    def to_dict(self) -> dict:
        ret = {"type": self.type, "crossCorrelograms": [a.to_dict() for a in self._cross_correlograms], "hideUnitSelector": self._hide_unit_selector}
        return ret
