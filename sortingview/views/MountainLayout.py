...
class MountainLayoutItem:
    def __init__(self, *, label: str, view: View, is_control: bool = False, control_height: Union[None, int] = None) -> None:
        self.label = label
        self.view = view
...
class MountainLayout(View):
    ...
    def __init__(self, items: List[MountainLayoutItem], **kwargs) -> None:
    ...
    def to_dict(self) -> dict:
        ...
        for item in self._items:
            ip = {"label": item.label, "isControl": item.is_control}
