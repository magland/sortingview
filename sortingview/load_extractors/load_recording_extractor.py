...
def load_recording_extractor(recording_object: Union[dict, str]):
    ...
    if "raw" in recording_object:
        return load_recording_extractor(dict(recording_format="mda", data=dict(raw=recording_object["raw"], geom=recording_object["geom"], params=recording_object["params"])))
