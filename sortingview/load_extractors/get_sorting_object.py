...
def get_sorting_object(sorting: si.BaseSorting):
    if hasattr(sorting, "sortingview_object"):
        ...
        sorting_object = {"sorting_format": "mda", "data": {"firings": firings_uri, "samplerate": sorting.get_sampling_frequency()}}
        ...
        nwb_file_uri = kcl.store_file_local(file_path, label=os.path.basename(file_path), reference=True)  # important to set reference=True because nwb file may be large
        sorting_object = {
            "sorting_format": "nwb2",
            "data": {"nwb_file_uri": nwb_file_uri, "electrical_series_name": electrical_series_name, "sampling_frequency": sampling_frequency},
        }
        ...
        sorting_object = {"sorting_format": "npz", "data": {"npz_file_uri": npz_file_uri}}
    else:
