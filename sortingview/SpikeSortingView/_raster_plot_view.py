...
def raster_plot_view(self, *, unit_ids: List[int], label: Union[str, None] = None, _subsample_max_firing_rate: Union[float, None] = None):
    ...
    for unit_id in unit_ids:
        ...
        plots.append(vv.RasterPlotItem(unit_id=unit_id, spike_times_sec=spike_times_sec.astype(np.float32)))

    return vv.RasterPlot(start_time_sec=0, end_time_sec=self.num_frames / self.sampling_frequency, plots=plots)
