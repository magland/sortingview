...
def cross_correlograms_view(self, *, unit_ids: List[int], hide_unit_selector: bool = False):
    ...
    for unit_id1 in unit_ids:
        ...
        for unit_id2 in unit_ids:
            ...
            cross_correlograms.append(vv.CrossCorrelogramItem(unit_id1=unit_id1, unit_id2=unit_id2, bin_edges_sec=bin_edges_sec, bin_counts=bin_counts))

    return vv.CrossCorrelograms(cross_correlograms=cross_correlograms, hide_unit_selector=hide_unit_selector)
