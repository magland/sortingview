...
def create_raster_plot(self, *, unit_ids: List[int], label: Union[str, None] = None, _subsample_max_firing_rate: Union[float, None] = None):
    ...
    for unit_id in unit_ids:
        ...
        plots.append({"unitId": unit_id, "spikeTimesSec": spike_times_sec.astype(np.float32)})

    data = {"type": "RasterPlot", "startTimeSec": 0, "endTimeSec": self.num_frames / self.sampling_frequency, "plots": plots}
