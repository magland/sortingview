...
const MWContainerTabBar: FunctionComponent<Props> = ({ views, currentView, onCurrentViewChanged, onViewClosed, active }) => {
    useEffect(() => {
    ...
    const handleClickView = useCallback((v: MWView) => {
...
const ViewContainerTab: FunctionComponent<{view: MWView, onClose: (v: MWView) => void, opts: {selected?: boolean}, onClick: (v: MWView) => void}> = ({view, onClose, opts, onClick}) => {
